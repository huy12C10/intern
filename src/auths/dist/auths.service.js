...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.validateUser = function (username, pass) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersService.findByEmail(username)];
                    case 1:
                        user = _b.sent();
                        _a = user;
                        if (!_a) return [3 /*break*/, 3];
                        return [4 /*yield*/, utils_1.comparePasswordHelper(pass, user.password)];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
                    case 3:
    ...
    AuthService.prototype.login = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        payload = { username: user.email, sub: user._id };
                        _a = {};
    ...
    AuthService.prototype.handleRegister = function (registerDto) {
        return this.usersService.handleRegister(registerDto);
    };
    AuthService.prototype.checkCode = function (data) {
        return this.usersService.handleActive(data);
    };
    AuthService.prototype.retryActive = function (data) {
        return this.usersService.retryActive(data);
    };
    AuthService.prototype.retryPassword = function (data) {
